...
<body>
    <div class="header">
        ...
        <div class="sponsordiv">
            ...
            <img class="sponsorlogo" width='40px' height='50px' src="{{ asset('img/monsterlogo.png') }}">
            <img class="sponsorlogo" width='35px' height='35px' src="{{ asset('img/omenlogo.png') }}">
            <img class="sponsorlogo" width='35px' height='35px' src="{{ asset('img/razerlogo.png') }}">
            <img class="sponsorlogo" width='50px' height='35px' src="{{ asset('img/steellogo.png') }}">
        </div>
    </div>
